...
?>
            <div class="col-4 mt-3">
                <div class="card ml-5" style="width: 17rem;">
                    <div class="card-header bg-danger text-white" style="font-weight: bold; font-size: 20px;"">Range Nilai</div>
            ...
            <div class="col-4 mt-3">
                <div class="card" style="width: 18rem;">
                    <div class="card-header bg-danger text-white" style="font-weight: bold; font-size: 20px;"">Predikat</div>
                        <ul class="list-group list-group-flush">
